(() => {
  "use strict";
  window.TWINSCOPE_EMBEDDED_PAYMENT_VERSION = "embedded-page-v2-20260717";
  ...
  async function initStripe() {
    ...
    try {
      ...
      /*
       * Stripe API 2026-03-25 renamed initEmbeddedCheckout()
       * to createEmbeddedCheckoutPage(). Keep the old method only as
       * a compatibility fallback for an older Stripe.js response.
       */
      const createEmbeddedPage =
      ...
      if (!createEmbeddedPage) {
        throw new Error(
          "This Stripe.js version does not expose the embedded Checkout API."
        );
      }

      embeddedCheckout = await createEmbeddedPage({
