...
def tour_to_dict(tour, absolute_url_builder=None, include_children=True):
    data = {
        ...
        "title": tour.title,
        "source_organization_id": tour.source_organization_id,
        "source_organization_name": getattr(tour.source_organization, "name", "") if tour.source_organization_id else "",
        "source_tour_id": tour.source_tour_id,
        "source_tour_title": getattr(tour.source_tour, "title", "") if tour.source_tour_id else "",
