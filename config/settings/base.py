...
PREVIEW_SPATIAL_POINT_BUDGET = config("PREVIEW_SPATIAL_POINT_BUDGET", default=24000, cast=int)
PREVIEW_SPATIAL_MESH_SEGMENTS = config("PREVIEW_SPATIAL_MESH_SEGMENTS", default=140, cast=int)
PREVIEW_SPATIAL_GRAPH_MAX_NODES = config("PREVIEW_SPATIAL_GRAPH_MAX_NODES", default=36, cast=int)
PREVIEW_SPATIAL_NATURAL_DRAG = config("PREVIEW_SPATIAL_NATURAL_DRAG", default=True, cast=bool)
PREVIEW_SPATIAL_INVERT_VERTICAL_DRAG = config(
    "PREVIEW_SPATIAL_INVERT_VERTICAL_DRAG", default=True, cast=bool
)
PREVIEW_SPATIAL_OPEN_PANORAMA_ON_CARD_CLICK = config(
    "PREVIEW_SPATIAL_OPEN_PANORAMA_ON_CARD_CLICK", default=True, cast=bool
)
...
STREETVIEW_DIRECT_UPLOAD_MAX_BYTES = config("STREETVIEW_DIRECT_UPLOAD_MAX_BYTES", default=120 * 1024 * 1024, cast=int)
STREETVIEW_CONNECTION_REPAIR_ATTEMPTS = config("STREETVIEW_CONNECTION_REPAIR_ATTEMPTS", default=5, cast=int)
STREETVIEW_CONNECTION_REPAIR_BASE_DELAY = config("STREETVIEW_CONNECTION_REPAIR_BASE_DELAY", default=2.0, cast=float)
TOUR_AI_EXTERNAL_EMBED_TIMEOUT_MS = config("TOUR_AI_EXTERNAL_EMBED_TIMEOUT_MS", default=7000, cast=int)
TOUR_AI_MAX_MESSAGE_CHARS = config("TOUR_AI_MAX_MESSAGE_CHARS", default=2000, cast=int)
